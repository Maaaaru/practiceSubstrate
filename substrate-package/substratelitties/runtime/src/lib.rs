...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("substratelitties"),
	impl_name: create_runtime_str!("substratelitties"),
	authoring_version: 3,
	spec_version: 4,
	impl_version: 4,
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		Substratelitties: substratekitties::{Module, Call, Storage, Event<T>},
